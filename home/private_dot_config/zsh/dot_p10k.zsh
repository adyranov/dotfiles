# Generated by Powerlevel10k configuration wizard on 2023-03-28 at 19:19 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_PYTHON_SHOW_ON_UPGLOB='*.py|Pipfile'
  ...
  typeset -g POWERLEVEL9K_ASDF_JAVA_SHOW_ON_UPGLOB='*.java|*.scala|*.kt'
  ...
  # Maven version from asdf.
  typeset -g POWERLEVEL9K_ASDF_MAVEN_FOREGROUND=32
  # typeset -g POWERLEVEL9K_ASDF_MAVEN_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_ASDF_MAVEN_SHOW_ON_UPGLOB='pom.xml'

  # Terraform version from asdf.
  typeset -g POWERLEVEL9K_ASDF_TERRAFORM_FOREGROUND=37
  ...
  typeset -g POWERLEVEL9K_ASDF_TERRAGRUNT_FOREGROUND=37
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=green
